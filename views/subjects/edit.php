<div class="w-25">
    <form method="POST" action="/admin/subjects/<?= $subject->subject_id ?>">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="subject_type" id="subject_type" required>
                ...
                <?php foreach($subjectTypes as $subjectType) : ?>
                    <option value="<?= $subjectType->subject_type_id ?>" <?= $subjectType->subject_type_id == $subject->subject_type_id ? "selected" : "" ?>>
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="number" name="ects_credits" id="ects_credits"
                   value="<?= $subject->ects_credits ?>" required/>
        </div>
